...
class VicController {
    ...
    findById(req, res) {
        ...
        this.vicDao.findById(id).then(this.common.findSuccess(res)).catch(this.common.findError(res));
    }
    ...
    findAll(req, res) {
        this.vicDao.findAll().then(this.common.findSuccess(res)).catch(this.common.findError(res));
    }
    query(req, res) {
        ...
        this.vicDao.findByPaging(pageNum, pageCount).then(this.common.findSuccess(res)).catch(this.common.findError(res));
    }
    nearst(req, res) {
        let n = req.query.n;
        if (!n) {
        ...
        if (!x || !y) {
            ...
            this.vicDao.findByNearst(x, y, n).then(this.common.findSuccess(res)).catch(this.common.findError(res));
        }
    }
}
